...
int main(void)
{
...
#else
	IP4_ADDR(&gw, 50, 50, 50, 100);
	IP4_ADDR(&ipaddr, 50, 50, 50, 1);
	IP4_ADDR(&netmask, 255, 0, 0, 0);
	IP4_ADDR(&ipaddr_dst, 50, 50, 50, 3);
	...
	echo_init(ipaddr , 15150, ipaddr_dst, 15160);
