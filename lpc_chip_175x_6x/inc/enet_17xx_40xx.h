 ...
 */
void Chip_ENET_SetupMII(LPC_ENET_T *pENET, uint32_t div);
 ...
 */
void Chip_ENET_StartMIIWrite(LPC_ENET_T *pENET, uint8_t reg, uint16_t data, uint32_t phyAddr);
 ...
 */
void Chip_ENET_StartMIIRead(LPC_ENET_T *pENET, uint8_t reg, uint32_t phyAddr);
